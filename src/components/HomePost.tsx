...
const HomePost = () => {
    ...
    //     axios.get('http://192.168.0.101:5229/api/ServicePost') // Update with your actual API URL
    //         .then((response) => {
...
useEffect(() => {
    const fetchServicePosts = axios.get('http://192.168.0.101:5140/api/ServicePost');
    const fetchJobPosts = axios.get('http://192.168.0.101:5140/api/JobPost');
